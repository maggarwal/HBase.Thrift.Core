                ...
                {
                  {
                    ...
                    for(int _i296 = 0; _i296 < _map295.Count; ++_i296)
                    {
                      byte[] _key297;
                      byte[] _val298;
                      _key297 = await iprot.ReadBinaryAsync(cancellationToken);
                      _val298 = await iprot.ReadBinaryAsync(cancellationToken);
                      Attributes[_key297] = _val298;
                    }
                    await iprot.ReadMapEndAsync(cancellationToken);
                  }
                }
      ...
      public async Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
      {
        ...
        try
        {
          ...
          if (Attributes != null && __isset.attributes)
          {
            ...
            {
              await oprot.WriteMapBeginAsync(new TMap(TType.String, TType.String, Attributes.Count), cancellationToken);
              foreach (byte[] _iter299 in Attributes.Keys)
              {
                await oprot.WriteBinaryAsync(_iter299, cancellationToken);
                await oprot.WriteBinaryAsync(Attributes[_iter299], cancellationToken);
              }
              await oprot.WriteMapEndAsync(cancellationToken);
            }
            await oprot.WriteFieldEndAsync(cancellationToken);
